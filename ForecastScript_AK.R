...
##
##EDDIE HUNSINGER, SEPTEMBER 2010 (UPDATED SEPTEMBER 2020)
...
BF30<-BF25<-BF20<-BF15<-BF10<-BF05<-0*SF05
  ##NOTE: THE TOP-ROW CALCULATION APPEARS A LITTLE OFF (SEE DIVIDING BY 10 AT THE FRONT) - POSSIBLY MEANT TO HELP MANAGE SEPARATE MALE AND FEMALE MATRICES, BUT WILL REVIEW
for(j in 1:SIZE-1)
